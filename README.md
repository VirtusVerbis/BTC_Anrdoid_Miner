...
**Digital rain (Matrix-style background)** — The main-screen animation adapts the column/trail logic from [Arduino DigitalRain Matrix](https://github.com/0015/Arduino_DigitalRain_Matrix) by Eric Nam ([`DigitalRainAnimation.hpp`](https://github.com/0015/Arduino_DigitalRain_Matrix/blob/main/src/DigitalRainAnimation.hpp)), **MIT License**. Kotlin lives under [`app/src/main/kotlin/com/btcminer/android/ui/digitalrain/`](app/src/main/kotlin/com/btcminer/android/ui/digitalrain/). **Config → Digital Rain** ([`DigitalRainConfigActivity.kt`](app/src/main/kotlin/com/btcminer/android/ui/digitalrain/DigitalRainConfigActivity.kt)) exposes a master on/off switch, **Canvas** vs **OpenGL ES backdrop** renderer choice ([`DigitalRainPreferences.kt`](app/src/main/kotlin/com/btcminer/android/ui/digitalrain/DigitalRainPreferences.kt); Canvas [`DigitalRainView.kt`](app/src/main/kotlin/com/btcminer/android/ui/digitalrain/DigitalRainView.kt), GPU [`DigitalRainGlView.kt`](app/src/main/kotlin/com/btcminer/android/ui/digitalrain/gl/DigitalRainGlView.kt) / GL stack in `ui/digitalrain/gl/`), **glyph atlas** preset **MATRIX** (ASCII-style) vs **BITCOIN_VS_FIAT** (₿, ⚡, fiat/currency symbols) ([`DigitalRainGlyphAtlasMode.kt`](app/src/main/kotlin/com/btcminer/android/ui/digitalrain/DigitalRainGlyphAtlasMode.kt)), plus motion, color, character, optional **depth** streaks, and **key mode** highlights ([`DigitalRainSettings.kt`](app/src/main/kotlin/com/btcminer/android/ui/digitalrain/DigitalRainSettings.kt)). The main activity can layer a **Satoshi Nakamoto** backdrop behind the rain, with an optional **Lightning** portrait variant, via `setSatoshiBackdrop` in [`MainActivity.kt`](app/src/main/kotlin/com/btcminer/android/MainActivity.kt).
